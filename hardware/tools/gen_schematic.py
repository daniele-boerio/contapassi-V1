...
COMPONENTS = [
    ...
    ("J1", "Connector:Conn_01x02_Pin", "pogo pin", "", "", (60, 320),
     {"1": "VIN", "2": "GND"}),
    ("J2", "Connector:Conn_01x02_Pin", "cella LiPo", "", "", (210, 320),
     {"1": "VBAT", "2": "GND"}),
    # ---- pad di test (accessibili prima del potting) ---------------------
    ("TP1", "Connector:TestPoint", "SWDIO", "", "", (590, 60), {"1": "SWDIO"}),
    ("TP2", "Connector:TestPoint", "SWCLK", "", "", (590, 85), {"1": "SWCLK"}),
    ("TP3", "Connector:TestPoint", "GND", "", "", (590, 110), {"1": "GND"}),
    ("TP4", "Connector:TestPoint", "+3V0", "", "", (590, 135), {"1": "+3V0"}),
    ("TP5", "Connector:TestPoint", "RESET", "", "", (590, 160), {"1": "RESET"}),
    ("TP6", "Connector:TestPoint", "P0.04", "", "", (590, 185), {"1": "SPARE"}),
